...
# --- ПУТИ ---
DIGITS_DIR = r"M:\ML_OCR\data_OCR\train_crop_number"
DIGITS_CSV = r"M:\ML_OCR\data_OCR\numbers_crop.csv"
GARBAGE_DIR = r"M:\ML_OCR\data_OCR\left_label"
OUTPUT_DIR = r"M:\ML_OCR\data_OCR\new_train"
OUTPUT_CSV = os.path.join(OUTPUT_DIR, "train.csv")

# --- ПАРАМЕТРЫ ГЕНЕРАЦИИ ---
# Ключ - длина ценника, значение - сколько штук сгенерировать
GEN_CONFIG = {
    2: 700,
    3: 500,
    4: 1300,
...
GARBAGE_PROBABILITY = 0.05 # 5% шанс
