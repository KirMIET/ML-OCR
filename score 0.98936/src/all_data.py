...
# --- НАСТРОЙКИ ПУТЕЙ ---
# ==========================================
REAL_IMG_DIR = "dataset/sint_real_data"
REAL_CSV_PATH = "dataset/sint_real_labels.csv"

SINT_IMG_DIR = "dataset/crop_train"
SINT_CSV_PATH = "dataset/crop_train.csv"
...
def process_dataset(source_img_dir, source_csv_path, output_dir, csv_writer, prefix):
    ...
    with open(source_csv_path, mode='r', encoding='utf-8-sig') as file:
        ...
        # Нормализуем заголовки (убираем пробелы по краям и делаем строчными)
        # Создаем словарь связи: нормализованное имя -> реальное имя в файле
